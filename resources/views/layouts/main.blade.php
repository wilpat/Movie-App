            ...
            <div class="flex items-center">
                <div class="relative">
                    ...
                    <div class="absolute top-0">
                        <svg class="fill-current text-gray-500 w-4 ml-2 mt-2" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
                    </div>
                </div>
                <div class="ml-4">
                    <a href="#">
                        <img src="/img/avatar.jpeg" alt="" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
