...
@section('content')
    <div class="actor-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $actor['profile_path'] }}" alt="{{ $actor['name'] }}" class="w-64 md:w-96 item-1" >
            ...
            <div class="item-2 movie-details md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm ">
                    ...
                    <span class="ml-2">{{ $actor['birthday'] }} ({{ $actor['age'] }} years old) | Born in {{ $actor['place_of_birth'] }}</span>
                </div>
